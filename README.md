...
🛡️ **REMnuxSec-Lab** – A malware analysis lab using **[REMnux](https://remnux.org/)** for **static malware analysis**. Includes setup instructions, safe practices, and guided analysis of a malware sample (malware.bin).
